            ...
            for record in reader:
                ...
                if wiz.csv_partner_ref_index and len(record) > wiz.csv_code_index \
                    ...
                    if re.match(wiz.csv_code_regexp, record_code) \
                        ...
                        partner_id = False
                        if record_partner_ref and re.match(wiz.csv_partner_ref_regexp, record_partner_ref):
                            partner_ids = self.pool.get('res.partner').search(cr, uid, [('ref','=',record_partner_ref)])
                            if partner_ids:
