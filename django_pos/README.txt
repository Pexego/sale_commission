...
DJ_UN = '' # Usuario de Django, necesario para la edición de las líneas
DJ_PW = '' # Contraseña del usuairo de Django

Y en el fichero de configuración del OpenERP, normalmente en /etc/openerp-server.conf
...
Esta aplicación esta testeada con Django 1.4.2
